...
export default function MenuCard({ name,description, price, imgUrl }) {
  return (
    <div className="flex flex-wrap justify-center gap-10 px-4">
      <img src={imgUrl} className="w-full hover:brightness-75 transition duration-300 cursor-pointer max-w-sm h-80 object-cover" />
      <div className="">
        <h2 className="text-lg font-semibold ">{name}</h2>
        <p className="w-full max-w-xl mt-2">{description}</p>
